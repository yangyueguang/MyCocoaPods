...
struct Font {
    static let mini   = NSFont.systemFont(ofSize: 9)
    static let small  = NSFont.systemFont(ofSize: 10)
    static let middle = NSFont.systemFont(ofSize: 12)
    static let normal = NSFont.systemFont(ofSize: 14)
    static let big    = NSFont.systemFont(ofSize: 16)
    static let large  = NSFont.systemFont(ofSize: 20)
